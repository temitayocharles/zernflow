...
export interface Company extends ProductRecord {
  name: string;
  domain: string;
  description: string;
...
export interface CustomerProfile extends ProductRecord {
  contact_id: string;
...
export interface Deal extends ProductRecord {
  name: string;
  description: string;
  company_id: string | null;
...
export interface WorkQueue extends ProductRecord {
  name: string;
  description: string;
}
export interface WorkItem extends ProductRecord {
  reference: number;
  name: string;
  description: string;
  kind: string;
...
export interface EditorialDraft extends ProductRecord {
  name: string;
  body: string;
  campaign: string;
  state: string;
...
export interface MailboxIdentity extends ProductRecord {
  name: string;
  address: string;
  gateway_account_ref: string;
}
export interface CannedReply extends ProductRecord {
  name: string;
  body: string;
}
...
export type ProductTables = {
  ...
  editorial_variants: Table<
    EditorialVariant,
    "workspace_id" | "draft_id" | "channel_id" | "body"
  >;
  knowledge_sources: Table<
    KnowledgeSource,
    "workspace_id" | "name" | "source_ref"
  >;
  mailbox_identities: Table<
    MailboxIdentity,
